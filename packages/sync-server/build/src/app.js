...
app.use((req, res, next) => {
    ...
    res.set('Content-Security-Policy', "default-src 'self' blob:; img-src 'self' blob: data:; script-src 'self' 'unsafe-eval' 'unsafe-inline' blob:; style-src 'self' 'unsafe-inline'; font-src 'self' data:; connect-src http: https:;");
    next();
});
if (process.env.NODE_ENV === 'development') {
