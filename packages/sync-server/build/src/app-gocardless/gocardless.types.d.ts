import type { Balance, GoCardlessAccountDetails, GoCardlessAccountId, GoCardlessAccountMetadata, GoCardlessInstitutionId, Institution, Transaction, Transactions } from './gocardless-node.types';
export type DetailedAccount = Omit<GoCardlessAccountDetails, 'status'> & GoCardlessAccountMetadata;
export type DetailedAccountWithInstitution = DetailedAccount & {
    institution: Institution | null;
};
export type TransactionWithBookedStatus = Transaction & {
    booked: boolean;
};
...
//# sourceMappingURL=gocardless.types.d.ts.map