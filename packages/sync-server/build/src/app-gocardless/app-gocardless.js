...
app.post('/transactions', handleError(async (req, res) => {
    const { requisitionId: rawRequisitionId, startDate, endDate, accountId: rawAccountId, includeBalance = true, } = req.body || {};
    ...
    try {
        ...
        const rateLimitHeaders = Object.fromEntries(Object.entries(headers).filter(([key]) => key.startsWith('x-ratelimit-')));
