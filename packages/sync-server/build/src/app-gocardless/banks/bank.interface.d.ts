import type { Balance, Transaction } from '#app-gocardless/gocardless-node.types';
import type { DetailedAccountWithInstitution, NormalizedAccountDetails } from '#app-gocardless/gocardless.types';
...
export type IBank = {
     ...
     * transaction date.
     */
    normalizeTransaction: (transaction: TransactionExtended, booked: boolean, editedTransaction?: TransactionExtended) => TransactionExtended | null;
    /**
...
export {};
//# sourceMappingURL=bank.interface.d.ts.map