 ...
 */
export declare function extractPayeeNameFromRemittanceInfo(remittanceInformationUnstructured?: string, patterns?: string[]): string;
//# sourceMappingURL=extract-payeeName-from-remittanceInfo.d.ts.map