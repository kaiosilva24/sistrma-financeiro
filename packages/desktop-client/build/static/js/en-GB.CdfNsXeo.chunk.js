//#region locale/en-GB.json
var Uncategorized = "Uncategorised";
var Reauthorize = "Reauthorise";
var Categorize = "Categorise";
var en_GB_default = {
	...
	"Conditional color (optional):": "Conditional colour (optional):",
	"Formula that returns a color (e.g., &ldquo;red&rdquo;, &ldquo;#ff0000&rdquo;). Leave blank for default. Use RESULT variable to access the main formula result.": "Formula that returns a colour (e.g., &ldquo;red&rdquo;, &ldquo;#ff0000&rdquo;). Leave blank for default. Use RESULT variable to access the main formula result.",
	"User defined tags with color and description.": "User defined tags with colour and description.",
	"{{count}} uncategorized transactions_one": "{{count}} uncategorised transaction",
	"{{count}} uncategorized transactions_other": "{{count}} uncategorised transactions",
	"Capitalizes first letter of each word.": "Capitalises first letter of each word.",
	"Set up your server below to enable seamless data synchronization across your devices, bank sync and more...": "Set up your server below to enable seamless data synchronisation across your devices, bank sync and more…",
	"Choose from catalog:": "Choose from catalogue:",
	"Failed to load theme catalog. You can still paste custom CSS below.": "Failed to load theme catalogue. You can still paste custom CSS below.",
	"<0><0>What is a Sankey plot?</0></0><1>A Sankey plot visualizes the flow of quantities between multiple categories, emphasizing the distribution and proportional relationships of data streams.</1><2><0>View options:</0></2><3><0><0>Spent:</0> Displays actual spending by category from transactions.</0><1><0>Budgeted:</0> Shows how your budget is allocated across categories.</1></3>": "<0><0>What is a Sankey plot?</0></0><1>A Sankey plot visualises the flow of quantities between multiple categories, emphasizing the distribution and proportional relationships of data streams.</1><2><0>View options:</0></2><3><0><0>Spent:</0> Displays actual spending by category from transactions.</0><1><0>Budgeted:</0> Shows how your budget is allocated across categories.</1></3>",
	"You have {{count}} uncategorized transactions (<3>{{amount}}</3>)_one": "You have {{count}} uncategorised transaction (<3>{{amount}}</3>)",
	"You have {{count}} uncategorized transactions (<3>{{amount}}</3>)_other": "You have {{count}} uncategorised transactions (<3>{{amount}}</3>)"
};
//#endregion
export { Categorize, Reauthorize, Uncategorized, en_GB_default as default };

//# sourceMappingURL=en-GB.CdfNsXeo.chunk.js.map