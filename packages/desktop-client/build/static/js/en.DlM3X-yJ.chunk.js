...
var IF = "IF";
var Import = "Import";
var Improving = "Improving";
var Income = "Income";
var indefinitely = "indefinitely";
var Inflow = "Inflow";
...
var or = "or";
var Outflow = "Outflow";
var Overbudgeted = "Overbudgeted";
var Overspent = "Overspent";
var Owner = "Owner";
var paid = "paid";
...
var en_default = {
	...
	"{{count}} payees_one": "{{count}} payee",
	"{{count}} payees_other": "{{count}} payees",
	"{{count}} transactions_one": "{{count}} transaction",
	"{{count}} transactions_other": "{{count}} transactions",
	"{{count}} uncategorized transactions_one": "{{count}} uncategorized transaction",
	...
	"<0><0>Understanding the Chart</0><1></1>• <3>Budgeted:</3> The amount you allocated each month<5></5>• <7>Spent:</7> Your actual spending<9></9>• <11>Overspending Adjustment:</11> Amounts from categories without rollover that were reset<13></13>• <15>Balance:</15> Your cumulative budget performance, starting with any prior balance. Respects category rollover settings from your budget.</0><1><0>Understanding the Budget Summary</0><1></1>The balance starts from the month before your selected period. Budgeted, spent, and overspending adjustments show totals over the period. Ending balance shows the final balance at period end. You can filter by categories to track changes in a specific area.</1><2>Hint: You can use the icon in the header to toggle between line and bar chart views.</2>": "<0><0>Understanding the Chart</0><1></1>• <3>Budgeted:</3> The amount you allocated each month<5></5>• <7>Spent:</7> Your actual spending<9></9>• <11>Overspending Adjustment:</11> Amounts from categories without rollover that were reset<13></13>• <15>Balance:</15> Your cumulative budget performance, starting with any prior balance. Respects category rollover settings from your budget.</0><1><0>Understanding the Budget Summary</0><1></1>The balance starts from the month before your selected period. Budgeted, spent, and overspending adjustments show totals over the period. Ending balance shows the final balance at period end. You can filter by categories to track changes in a specific area.</1><2>Hint: You can use the icon in the header to toggle between line and bar chart views.</2>",
	"<0><0>What is a Sankey plot?</0></0><1>A Sankey plot visualizes the flow of quantities between multiple categories, emphasizing the distribution and proportional relationships of data streams.</1><2><0>View options:</0></2><3><0><0>Spent:</0> Displays actual spending by category from transactions.</0><1><0>Budgeted:</0> Shows how your budget is allocated across categories.</1></3>": "<0><0>What is a Sankey plot?</0></0><1>A Sankey plot visualizes the flow of quantities between multiple categories, emphasizing the distribution and proportional relationships of data streams.</1><2><0>View options:</0></2><3><0><0>Spent:</0> Displays actual spending by category from transactions.</0><1><0>Budgeted:</0> Shows how your budget is allocated across categories.</1></3>",
	...
	"<0>Warning:</0> This transaction is {{daysUntilTransaction}} days away, which is beyond your configured upcoming length of {{upcomingDays}} days. The schedule preview will not be visible in your account until it gets closer to the date.": "<0>Warning:</0> This transaction is {{daysUntilTransaction}} days away, which is beyond your configured upcoming length of {{upcomingDays}} days. The schedule preview will not be visible in your account until it gets closer to the date.",
	...
	"30 days": "30 days",
	"6 months": "6 months",
	"A category group with name \"{{name}}\" already exists.": "A category group with name \"{{name}}\" already exists.",
	...
	"a fixed percent of the remainder": "a fixed percent of the remainder",
	"A higher Age of Money means you're spending older money, which indicates you're living on last month's income rather than paycheck-to-paycheck. An age of 30 days or more is considered ideal—it means you're typically spending money you earned a month ago.": "A higher Age of Money means you're spending older money, which indicates you're living on last month's income rather than paycheck-to-paycheck. An age of 30 days or more is considered ideal—it means you're typically spending money you earned a month ago.",
	...
	account,
	Account,
	"Account balance as of the date of the transaction, excluding the transaction amount. Use for calculations and comparisons.\n\nExample: `=IF(balance < 0, \"Negative Balance\", \"Positive Balance\")`": "Account balance as of the date of the transaction, excluding the transaction amount. Use for calculations and comparisons.\n\nExample: `=IF(balance < 0, \"Negative Balance\", \"Positive Balance\")`",
	...
	"Account name (string). The human-readable name of the account.\n\nExample: `=CONCATENATE(\"Paid from \", account_name)`": "Account name (string). The human-readable name of the account.\n\nExample: `=CONCATENATE(\"Paid from \", account_name)`",
	"Account not found": "Account not found",
	"Account page general": "Account page general",
	"Account sync": "Account sync",
	"Account transaction editing": "Account transaction editing",
	"Account transaction management": "Account transaction management",
	"Account transaction selection": "Account transaction selection",
	"Account:": "Account:",
	Accounts,
	Actions,
	...
	Add: "Add",
	"Add a balance limit automation to set the refill target.": "Add a balance limit automation to set the refill target.",
	...
	"Add balance limit": "Add balance limit",
	"Add balance limit automation": "Add balance limit automation",
	...
	"Add transaction and close form": "Add transaction and close form",
	"Add user": "Add user",
	"Additional CSS overrides:": "Additional CSS overrides:",
	Admin,
	...
	"Age of Money Report": "Age of Money Report",
	"Age of Money shows how many days, on average, your money sits in your budget before you spend it. It measures the gap between when you earn money and when you spend it.": "Age of Money shows how many days, on average, your money sits in your budget before you spend it. It measures the gap between when you earn money and when you spend it.",
	"Age of Money: {{days}} days": "Age of Money: {{days}} days",
	all: "all",
	...
	allocate,
	"Already imported transaction. You can skip it, or import it again.": "Already imported transaction. You can skip it, or import it again.",
	amount,
	Amount,
	...
	"Amount:": "Amount:",
	"an equal portion of the remainder": "an equal portion of the remainder",
	...
	"Are you sure you want to delete the transaction?": "Are you sure you want to delete the transaction?",
	"Are you sure you want to delete these {{count}} transactions?_one": "Are you sure you want to delete these {{count}} transactions?",
	"Are you sure you want to delete these {{count}} transactions?_other": "Are you sure you want to delete these {{count}} transactions?",
	...
	"Automatically rename these payees in the future": "Automatically rename these payees in the future",
	"Available for download": "Available for download",
	"Available funds": "Available funds",
	"Available funds to budget": "Available funds to budget",
	average,
	Average,
	"AVERAGE BUDGETED": "AVERAGE BUDGETED",
	...
	"Balance on that date:": "Balance on that date:",
	"Balance:": "Balance:",
	Bank,
	...
	Banners,
	"Bar Graph": "Bar Graph",
	"based on a formula": "based on a formula",
	Basic,
	...
	"Boolean cleared status. TRUE if transaction is cleared, FALSE otherwise.\n\nExample: `=IF(cleared, \"Cleared\", \"Pending\")`": "Boolean cleared status. TRUE if transaction is cleared, FALSE otherwise.\n\nExample: `=IF(cleared, \"Cleared\", \"Pending\")`",
	"Boolean reconciled status. TRUE if transaction is reconciled, FALSE otherwise.": "Boolean reconciled status. TRUE if transaction is reconciled, FALSE otherwise.",
	...
	"Budget <2>{{amount}}</2> each week": "Budget <2>{{amount}}</2> each week",
	"Budget analysis": "Budget analysis",
	"Budget Analysis": "Budget Analysis",
	"Budget Analysis Report": "Budget Analysis Report",
	"Budget automations: {{category}}": "Budget automations: {{category}}",
	...
	"By enabling this, the transaction date will be overwritten by the one provided by the bank.": "By enabling this, the transaction date will be overwritten by the one provided by the bank.",
	Cadence,
	"Calculates difference between dates in days.": "Calculates difference between dates in days.",
	"Calculates distance between dates.": "Calculates distance between dates.",
	"Calculates future value of investment.": "Calculates future value of investment.",
	"Calculates interest rate per period.": "Calculates interest rate per period.",
	"Calculates internal rate of return.": "Calculates internal rate of return.",
	"Calculates net present value.": "Calculates net present value.",
	"Calculates payment for a loan.": "Calculates payment for a loan.",
	"Calculates present value of investment.": "Calculates present value of investment.",
	Calendar,
	...
	"Capitalizes first letter of each word.": "Capitalizes first letter of each word.",
	"Cash Flow": "Cash Flow",
	...
	"Category ID (string). The ID of the category.\n\nExample: `=IF(category=\"Groceries\", \"Food\", \"Other\")`": "Category ID (string). The ID of the category.\n\nExample: `=IF(category=\"Groceries\", \"Food\", \"Other\")`",
	...
	"Category Name (string). The human-readable name of the category.\n\nExample: `=IF(category_name=\"Groceries\", \"Food\", \"Other\")`": "Category Name (string). The human-readable name of the category.\n\nExample: `=IF(category_name=\"Groceries\", \"Food\", \"Other\")`",
	"Category+Group": "Category+Group",
	Center,
	Change,
	"Change category automations": "Change category automations",
	"Change category limit": "Change category limit",
	"Change category sort order": "Change category sort order",
	...
	"Checks multiple conditions and returns corresponding values.": "Checks multiple conditions and returns corresponding values.",
	...
	"Client-Side plugins (soon)": "Client-Side plugins (soon)",
	Close,
	...
	"Closed: {{accountName}}": "Closed: {{accountName}}",
	"Closing balance with extracted parameters from {{queryName}}.": "Closing balance with extracted parameters from {{queryName}}.",
	"Closing...": "Closing...",
	...
	"Combines several text strings into one.": "Combines several text strings into one.",
	...
	Complete,
	completed,
	"Conditional color (optional):": "Conditional color (optional):",
	...
	"Connection failed. If you use a self-signed certificate or were recently offline, try refreshing the page. Otherwise ensure you have HTTPS set up properly.": "Connection failed. If you use a self-signed certificate or were recently offline, try refreshing the page. Otherwise ensure you have HTTPS set up properly.",
	...
	contains,
	"Convert to Schedule": "Convert to Schedule",
	"Converts integer amount to decimal amount (e.g., 1234 -> 12.34).": "Converts integer amount to decimal amount (e.g., 1234 -> 12.34).",
	"Converts number to character.": "Converts number to character.",
	"Converts number to text with format.": "Converts number to text with format.",
	"Converts text to a number.": "Converts text to a number.",
	...
	"Counts cells that meet a criteria.": "Counts cells that meet a criteria.",
	"Counts cells that meet multiple criteria.": "Counts cells that meet multiple criteria.",
	"Counts empty cells.": "Counts empty cells.",
	"Counts non-empty values.": "Counts non-empty values.",
	"Counts the number of numeric values.": "Counts the number of numeric values.",
	Cover,
	...
	"Cover this amount:": "Cover this amount:",
	"Covered {{amount}} {{toCategoryName}} overspending from {{fromCategoryName}}.": "Covered {{amount}} {{toCategoryName}} overspending from {{fromCategoryName}}.",
	...
	"Crossover Point": "Crossover Point",
	"Crossover Report": "Crossover Report",
	...
	"Custom CSS is active": "Custom CSS is active",
	"Custom CSS override active — click to edit": "Custom CSS override active — click to edit",
	...
	Declining,
	"Decrypt budget file": "Decrypt budget file",
	Default,
	DEFAULT,
	...
	"Disable formula": "Disable formula",
	...
	Display,
	"Display a notification when updates are available": "Display a notification when updates are available",
	...
	"Duplicate the selected transactions": "Duplicate the selected transactions",
	...
	"Error:": "Error:",
	Euro,
	"Evaluate a budget query using extracted parameters. Supply dimension, categories, and timeframe explicitly.": "Evaluate a budget query using extracted parameters. Supply dimension, categories, and timeframe explicitly.",
	...
	Example,
	"Excel formula mode (Formula cards & Rule formulas)": "Excel formula mode (Formula cards & Rule formulas)",
	"Excess funds mode": "Excess funds mode",
	"Execute a query and return the number of matching rows.": "Execute a query and return the number of matching rows.",
	"Execute a query and return the result.": "Execute a query and return the result.",
	"Execute the {{queryName}} query and return the number of matching rows.": "Execute the {{queryName}} query and return the number of matching rows.",
	"Execute the {{queryName}} query and return the result.": "Execute the {{queryName}} query and return the result.",
	...
	"Exit reconciliation": "Exit reconciliation",
	Expand,
	"Expand all": "Expand all",
	"Expand month summary": "Expand month summary",
	"Expand split transactions": "Expand split transactions",
	"Expected monthly contribution": "Expected monthly contribution",
	"Expected return (annual %)": "Expected return (annual %)",
	"Expense category groups": "Expense category groups",
	"Expense Projection Type": "Expense Projection Type",
	Expenses,
	...
	"Export query configuration": "Export query configuration",
	"Export transactions": "Export transactions",
	"Extract category IDs from a named query.": "Extract category IDs from a named query.",
	"Extract the end month from a named query timeframe.": "Extract the end month from a named query timeframe.",
	"Extract the start month from a named query timeframe.": "Extract the start month from a named query timeframe.",
	...
	"Failed to delete payee. Please try again.": "Failed to delete payee. Please try again.",
	"Failed to delete rule. Please try again.": "Failed to delete rule. Please try again.",
	"Failed to delete schedule. Please try again.": "Failed to delete schedule. Please try again.",
	"Failed to download the budget because your device time differs too much from the server. Please check your device time settings and ensure they are correct.": "Failed to download the budget because your device time differs too much from the server. Please check your device time settings and ensure they are correct.",
	...
	"Failed to load theme": "Failed to load theme",
	"Failed to load theme catalog. You can still paste custom CSS below.": "Failed to load theme catalog. You can still paste custom CSS below.",
	...
	"Failed to sync because your device time differs too much from the server. Please check your device time settings and ensure they are correct.": "Failed to sync because your device time differs too much from the server. Please check your device time settings and ensure they are correct.",
	"Failed to transfer ownership": "Failed to transfer ownership",
	"Failed to update payee. Please try again.": "Failed to update payee. Please try again.",
	"Failed to validate theme CSS": "Failed to validate theme CSS",
	...
	Filters,
	"Filters on <1>{ignoredFilterFieldsList}</1> are ignored in <4>Budgeted</4> mode.": "Filters on <1>{ignoredFilterFieldsList}</1> are ignored in <4>Budgeted</4> mode.",
	"Filters:": "Filters:",
	...
	"Find value required": "Find value required",
	"Finds text within text (case-insensitive, supports wildcards).": "Finds text within text (case-insensitive, supports wildcards).",
	"Finds text within text (case-sensitive).": "Finds text within text (case-sensitive).",
	...
	forget,
	"Formats a number to a fixed amount of decimal places.": "Formats a number to a fixed amount of decimal places.",
	Formula,
	"formula ": "formula ",
	"Formula card": "Formula card",
	"Formula mode indicator": "Formula mode indicator",
	"Formula that returns a color (e.g., &ldquo;red&rdquo;, &ldquo;#ff0000&rdquo;). Leave blank for default. Use RESULT variable to access the main formula result.": "Formula that returns a color (e.g., &ldquo;red&rdquo;, &ldquo;#ff0000&rdquo;). Leave blank for default. Use RESULT variable to access the main formula result.",
	"Formula:": "Formula:",
	...
	"Hampel Filtered Median": "Hampel Filtered Median",
	...
	"Hide balance chart": "Hide balance chart",
	...
	"How past expenses are projected into the future.<1></1><2></2>Hampel Filtered Median: Filters out outliers before calculating the median expense.<4></4><5></5>Median: Uses the median of all historical expenses without filtering.<7></7><8></8>Mean: Uses the average of all historical expenses.": "How past expenses are projected into the future.<1></1><2></2>Hampel Filtered Median: Filters out outliers before calculating the median expense.<4></4><5></5>Median: Uses the median of all historical expenses without filtering.<7></7><8></8>Mean: Uses the average of all historical expenses.",
	...
	"Import query configuration": "Import query configuration",
	"Import Query Configuration": "Import Query Configuration",
	...
	"In/Out": "In/Out",
	"In/Out outflow value": "In/Out outflow value",
	...
	"Install Custom Theme": "Install Custom Theme",
	...
	"Invalid JSON. Please check your input.": "Invalid JSON. Please check your input.",
	"Invalid password": "Invalid password",
	"Invalid regular expression": "Invalid regular expression",
	"Invalid rule": "Invalid rule",
	"Invalid: unable to parse the value": "Invalid: unable to parse the value",
	"Invalid: unable to parse the value ({{amount}})": "Invalid: unable to parse the value ({{amount}})",
	...
	"Link or unlink accounts": "Link or unlink accounts",
	...
	"Loading...": "Loading…",
	Local,
	"Lock transactions": "Lock transactions",
	...
	Long,
	Long_noun,
	"Looks up values in a vector or array.": "Looks up values in a vector or array.",
	...
	matches,
	"Matches expression against values and returns corresponding result.": "Matches expression against values and returns corresponding result.",
	Mean,
	Median,
	Menu,
	Merge,
	"Merge and edit rule": "Merge and edit rule",
	"Merge the selected transactions": "Merge the selected transactions",
	"Merge with existing transactions": "Merge with existing transactions",
	"Merging will delete the selected payee(s) and transfer any associated rules to the target payee.": "Merging will delete the selected payee(s) and transfer any associated rules to the target payee.",
	...
	"Monthly investment income:": "Monthly investment income:",
	...
	"Move down to next category": "Move down to next category",
	"Move down to the next transaction": "Move down to the next transaction",
	"Move down to the next transaction and scroll": "Move down to the next transaction and scroll",
	...
	"Move up to next category": "Move up to next category",
	"Move up to the next transaction": "Move up to the next transaction",
	"Move up to the next transaction and scroll": "Move up to the next transaction and scroll",
	...
	Multiplier,
	"Multiplies corresponding elements and returns the sum.": "Multiplies corresponding elements and returns the sum.",
	...
	"New transaction. You can import it, or skip it.": "New transaction. You can import it, or skip it.",
	"New version available: {versionInfo.latestVersion}": "New version available: {versionInfo.latestVersion}",
	"Next date": "Next date",
	...
	"No data available for this period. Try adding transactions or selecting a different period.": "No data available for this period. Try adding transactions or selecting a different period.",
	"No data available for this period. Try budgeting categories or selecting a different period.": "No data available for this period. Try budgeting categories or selecting a different period.",
	...
	"No other dashboard pages available.": "No other dashboard pages available.",
	"No payee": "No payee",
	"No payees": "No payees",
	"No payees found.": "No payees found.",
	"No payees selected": "No payees selected",
	"No queries defined. Click 'Add Query' to create your first query.": "No queries defined. Click 'Add Query' to create your first query.",
	"No recurring date": "No recurring date",
	"No results found": "No results found",
	"No rules": "No rules",
	"No rules found. Create your first rule to get started!": "No rules found. Create your first rule to get started!",
	...
	"No schedules found. Create your first schedule to get started!": "No schedules found. Create your first schedule to get started!",
	"No server": "No server",
	...
	"No, keep as transaction": "No, keep as transaction",
	None,
	...
	"Note: Some expenses could not be matched to income (spending exceeded income in this period)": "Note: Some expenses could not be matched to income (spending exceeded income in this period)",
	notes,
	Notes,
	...
	"one of": "one of",
	"Only import transactions since:": "Only import transactions since:",
	...
	"Opening balance with extracted parameters from {{queryName}}.": "Opening balance with extracted parameters from {{queryName}}.",
	"Opening last budget...": "Opening last budget…",
	Options,
	or: "or",
	"Original imported payee name from bank import. Contains the raw text before matching.\n\nExample: `=LEFT(imported_payee, 10)` to get first 10 characters": "Original imported payee name from bank import. Contains the raw text before matching.\n\nExample: `=LEFT(imported_payee, 10)` to get first 10 characters",
	"Original templates:<1>{templates}</1>": "Original templates:<1>{templates}</1>",
	Outflow,
	Overbudgeted,
	"Overbudgeted:": "Overbudgeted:",
	"Overfunded ({{amount}})": "Overfunded ({{amount}})",
	"Overspending adj:": "Overspending adj:",
	"Overspending Adjustment": "Overspending Adjustment",
	"Overspending Adjustment:": "Overspending Adjustment:",
	Overspent,
	...
	"Overwrite with template": "Overwrite with template",
	"Overwrite with templates": "Overwrite with templates",
	Owner,
	"Owner:": "Owner:",
	paid,
	"Parameters:": "Parameters:",
	"Parses a date string and returns it as a number.": "Parses a date string and returns it as a number.",
	Password,
	...
	payee,
	Payee,
	"Payee \"{{name}}\" deleted successfully": "Payee \"{{name}}\" deleted successfully",
	"payee (name)": "payee (name)",
	"Payee {{oldName}} renamed to {{newName}}": "Payee {{oldName}} renamed to {{newName}}",
	"Payee ID (string). The ID of the payee.\n\nExample: `=CONCATENATE(\"Payment to \", payee)`": "Payee ID (string). The ID of the payee.\n\nExample: `=CONCATENATE(\"Payment to \", payee)`",
	"Payee Locations": "Payee Locations",
	"Payee name": "Payee name",
	"Payee name (string). The human-readable name of the payee.\n\nExample: `=UPPER(payee_name)` or `=CONCATENATE(\"Payment to \", payee_name)`": "Payee name (string). The human-readable name of the payee.\n\nExample: `=UPPER(payee_name)` or `=CONCATENATE(\"Payment to \", payee_name)`",
	"Payee:": "Payee:",
	Payees,
	Payment,
	PAYMENT,
	...
	"Please provide the encryption key to unlock this budget file. You may be unlocking it for the first time, or the key has changed. Enter your password to continue.": "Please provide the encryption key to unlock this budget file. You may be unlocking it for the first time, or the key has changed. Enter your password to continue.",
	"Please select a dashboard to save the report": "Please select a dashboard to save the report",
	...
	"Queries allow you to reference filtered transaction data in your formulas using QUERY('queryName') or QUERY_COUNT('queryName')": "Queries allow you to reference filtered transaction data in your formulas using QUERY('queryName') or QUERY_COUNT('queryName')",
	"Query configuration copied to clipboard": "Query configuration copied to clipboard",
	"Query Definitions": "Query Definitions",
	"Query name (e.g., 'expenses', 'income')": "Query name (e.g., 'expenses', 'income')",
	"Query with this name already exists": "Query with this name already exists",
	"QUERY('{queryName}')": "QUERY('{queryName}')",
	"Quoted account id or exact account name": "Quoted account id or exact account name",
	"Range:": "Range:",
	...
	reconciled,
	Reconciled,
	"Reconciled {{ relativeTimeAgo }} ({{ absoluteDate }})": "Reconciled {{ relativeTimeAgo }} ({{ absoluteDate }})",
	...
	"Refill the category up to the balance limit set by the balance limit automation.": "Refill the category up to the balance limit set by the balance limit automation.",
	"Refill to balance limit": "Refill to balance limit",
	Refresh,
	Register,
	...
	"Remove all funds over the limit": "Remove all funds over the limit",
	...
	"Removes non-printable characters from text.": "Removes non-printable characters from text.",
	Rename,
	...
	Repeats,
	"Repeats text specified number of times.": "Repeats text specified number of times.",
	Replace,
	"Replaces occurrences of text.": "Replaces occurrences of text.",
	"Replaces substring at specified position.": "Replaces substring at specified position.",
	...
	"Result:": "Result:",
	"Retain any funds over the limit": "Retain any funds over the limit",
	"Retrieving remote files...": "Retrieving remote files…",
	"Returns -1 for negative, 0 for zero, 1 for positive.": "Returns -1 for negative, 0 for zero, 1 for positive.",
	...
	"Returns date as number of days since null date.": "Returns date as number of days since null date.",
	"Returns date shifted by specified months.": "Returns date shifted by specified months.",
	"Returns day of week (1-7).": "Returns day of week (1-7).",
	"Returns e raised to the power of number.": "Returns e raised to the power of number.",
	"Returns ISO week number.": "Returns ISO week number.",
	"Returns last day of month after specified months.": "Returns last day of month after specified months.",
	"Returns leftmost characters from text.": "Returns leftmost characters from text.",
	"Returns length of text.": "Returns length of text.",
	"Returns number of working days between dates.": "Returns number of working days between dates.",
	"Returns numeric code for first character.": "Returns numeric code for first character.",
	"Returns one value if condition is TRUE, another if FALSE.": "Returns one value if condition is TRUE, another if FALSE.",
	"Returns position of value in array.": "Returns position of value in array.",
	"Returns rightmost characters from text.": "Returns rightmost characters from text.",
	"Returns substring from specified position.": "Returns substring from specified position.",
	"Returns text if value is text, empty string otherwise.": "Returns text if value is text, empty string otherwise.",
	"Returns the absolute value of a number.": "Returns the absolute value of a number.",
	"Returns the average of all numbers in a range.": "Returns the average of all numbers in a range.",
	"Returns the average, including text and logical values.": "Returns the average, including text and logical values.",
	"Returns the base-10 logarithm.": "Returns the base-10 logarithm.",
	"Returns the cosine of an angle.": "Returns the cosine of an angle.",
	"Returns the day from a date.": "Returns the day from a date.",
	"Returns the k-th percentile.": "Returns the k-th percentile.",
	"Returns the logarithm to specified base.": "Returns the logarithm to specified base.",
	"Returns the logical value FALSE.": "Returns the logical value FALSE.",
	"Returns the logical value TRUE.": "Returns the logical value TRUE.",
	"Returns the maximum value, including text and logical values.": "Returns the maximum value, including text and logical values.",
	"Returns the maximum value.": "Returns the maximum value.",
	"Returns the median value.": "Returns the median value.",
	"Returns the minimum value, including text and logical values.": "Returns the minimum value, including text and logical values.",
	"Returns the minimum value.": "Returns the minimum value.",
	"Returns the month from a date.": "Returns the month from a date.",
	"Returns the most frequently occurring value.": "Returns the most frequently occurring value.",
	"Returns the natural logarithm.": "Returns the natural logarithm.",
	"Returns the product of all numbers.": "Returns the product of all numbers.",
	"Returns the quartile of a dataset.": "Returns the quartile of a dataset.",
	"Returns the rank of a number in a list.": "Returns the rank of a number in a list.",
	"Returns the remainder of division.": "Returns the remainder of division.",
	"Returns the sine of an angle.": "Returns the sine of an angle.",
	"Returns the square root.": "Returns the square root.",
	"Returns the standard deviation of a population.": "Returns the standard deviation of a population.",
	"Returns the standard deviation of a sample.": "Returns the standard deviation of a sample.",
	"Returns the sum of all numbers in a range.": "Returns the sum of all numbers in a range.",
	"Returns the sum of all numbers.": "Returns the sum of all numbers.",
	"Returns the sum of the squares.": "Returns the sum of the squares.",
	"Returns the tangent of an angle.": "Returns the tangent of an angle.",
	"Returns the value of PI.": "Returns the value of PI.",
	"Returns the variance of a population.": "Returns the variance of a population.",
	"Returns the variance of a sample.": "Returns the variance of a sample.",
	"Returns the year from a date.": "Returns the year from a date.",
	"Returns TRUE if all arguments are TRUE.": "Returns TRUE if all arguments are TRUE.",
	"Returns TRUE if any argument is TRUE.": "Returns TRUE if any argument is TRUE.",
	"Returns TRUE if number is even.": "Returns TRUE if number is even.",
	"Returns TRUE if number is odd.": "Returns TRUE if number is odd.",
	"Returns TRUE if odd number of arguments are TRUE.": "Returns TRUE if odd number of arguments are TRUE.",
	"Returns TRUE if texts are exactly the same.": "Returns TRUE if texts are exactly the same.",
	"Returns TRUE if value is #N/A error.": "Returns TRUE if value is #N/A error.",
	...
	"Returns TRUE if value is any error.": "Returns TRUE if value is any error.",
	"Returns TRUE if value is blank.": "Returns TRUE if value is blank.",
	"Returns TRUE if value is logical (TRUE/FALSE).": "Returns TRUE if value is logical (TRUE/FALSE).",
	"Returns TRUE if value is text.": "Returns TRUE if value is text.",
	"Returns value at specified row and column.": "Returns value at specified row and column.",
	"Returns value from list based on index.": "Returns value from list based on index.",
	"Returns value if no error, otherwise returns alternative.": "Returns value if no error, otherwise returns alternative.",
	"Returns value if not #N/A error, otherwise returns alternative.": "Returns value if not #N/A error, otherwise returns alternative.",
	"Returns week number of year.": "Returns week number of year.",
	"Reverses the logical value.": "Reverses the logical value.",
	Revert,
	"Revert changes": "Revert changes",
	"Revert to Latest": "Revert to Latest",
	...
	"Rounds a number to specified decimals.": "Rounds a number to specified decimals.",
	"Rounds down to nearest integer.": "Rounds down to nearest integer.",
	"Rounds down to nearest multiple of significance.": "Rounds down to nearest multiple of significance.",
	"Rounds down to specified decimals.": "Rounds down to specified decimals.",
	"Rounds up to nearest multiple of significance.": "Rounds up to nearest multiple of significance.",
	"Rounds up to specified decimals.": "Rounds up to specified decimals.",
	Rule,
	"Rule {{id}}": "Rule {{id}}",
	...
	"Run Rules": "Run Rules",
	"Running balance for another account (cents) at this transaction, same cutoff as balance. Use a quoted account id for a deterministic match, or a quoted account name. Use the balance variable instead for the current account.": "Running balance for another account (cents) at this transaction, same cutoff as balance. Use a quoted account id for a deterministic match, or a quoted account name. Use the balance variable instead for the current account.",
	"Russian Ruble": "Russian Ruble",
	"Safe withdrawal rate (%)": "Safe withdrawal rate (%)",
	Sankey,
	"Sankey card": "Sankey card",
	"Sankey report": "Sankey report",
	Saturday,
	...
	"Save failed: No widget found to save.": "Save failed: No widget found to save.",
	"Save new filter": "Save new filter",
	"Save new report": "Save new report",
	"Save notes": "Save notes",
	"Save notes & un-migrate": "Save notes & un-migrate",
	...
	"Search Off Budget Accounts": "Search Off Budget Accounts",
	"Search On Budget Accounts": "Search On Budget Accounts",
	"Search results": "Search results",
	"Search shortcuts": "Search shortcuts",
	"Searches horizontally in first row and returns value.": "Searches horizontally in first row and returns value.",
	"Searches vertically in first column and returns value.": "Searches vertically in first column and returns value.",
	"Secret ID:": "Secret ID:",
	...
	"Selecting this option will disable importing transactions and only import the account balance for use in reconciliation": "Selecting this option will disable importing transactions and only import the account balance for use in reconciliation",
	...
	"Server is offline. OpenID settings are unavailable.": "Server is offline. OpenID settings are unavailable.",
	...
	set: "set",
	"Set a balance limit of {{daily}}/day (hard cap)": "Set a balance limit of {{daily}}/day (hard cap)",
	"Set a balance limit of {{daily}}/day (soft cap)": "Set a balance limit of {{daily}}/day (soft cap)",
	"Set a balance limit of {{monthly}}/month (hard cap)": "Set a balance limit of {{monthly}}/month (hard cap)",
	"Set a balance limit of {{monthly}}/month (soft cap)": "Set a balance limit of {{monthly}}/month (soft cap)",
	"Set a balance limit of {{weekly}}/week (hard cap)": "Set a balance limit of {{weekly}}/week (hard cap)",
	"Set a balance limit of {{weekly}}/week (soft cap)": "Set a balance limit of {{weekly}}/week (soft cap)",
	"Set a cap for all budget contributions to this category across all automations. The maximum can be set on a monthly, weekly, or daily basis. For example, a $100 weekly cap would result in a $400 monthly cap ($500 depending on the month).": "Set a cap for all budget contributions to this category across all automations. The maximum can be set on a monthly, weekly, or daily basis. For example, a $100 weekly cap would result in a $400 monthly cap ($500 depending on the month).",
	...
	"Set amount for selected transactions": "Set amount for selected transactions",
	...
	"Set date for selected transactions": "Set date for selected transactions",
	...
	"Show {{count}} unused payees_one": "Show {{count}} unused payees",
	"Show {{count}} unused payees_other": "Show {{count}} unused payees",
	"Show {{n}}": "Show {{n}}",
	"Show advanced settings": "Show advanced settings",
	"Show all payees": "Show all payees",
	"Show as": "Show as",
	"Show as percentages": "Show as percentages",
	"Show balance": "Show balance",
	"Show balance chart": "Show balance chart",
	"Show completed schedules": "Show completed schedules",
	"Show empty rows": "Show empty rows",
	"Show Error": "Show Error",
	"Show filter dropdown when no transactions are selected": "Show filter dropdown when no transactions are selected",
	...
	"Skip end lines:": "Skip end lines:",
	"Skip next scheduled date": "Skip next scheduled date",
	"Skip start lines:": "Skip start lines:",
	...
	"Something went wrong loading this section.": "Something went wrong loading this section.",
	...
	"Sort all": "Sort all",
	"Sort as budget": "Sort as budget",
	"Sort per group": "Sort per group",
	"Sort:": "Sort:",
	Source,
	...
	"Split:": "Split:",
	"Splits text by space and returns part at index.": "Splits text by space and returns part at index.",
	...
	Sum: "Sum",
	"Sum of budgeted amounts with extracted parameters from {{queryName}}.": "Sum of budgeted amounts with extracted parameters from {{queryName}}.",
	"Sum of spending with extracted parameters from {{queryName}}.": "Sum of spending with extracted parameters from {{queryName}}.",
	Summary,
	"Summary card": "Summary card",
	"Sums cells that meet a criteria.": "Sums cells that meet a criteria.",
	"Sums cells that meet multiple criteria.": "Sums cells that meet multiple criteria.",
	Sunday,
	"Swap Payee and Memo": "Swap Payee and Memo",
	...
	"Switch to line chart": "Switch to line chart",
	...
	Tags,
	"Target Income (% of expenses)": "Target Income (% of expenses)",
	"Target income:": "Target income:",
	"Target Life Savings": "Target Life Savings",
	"Target Monthly Income": "Target Monthly Income",
	Template,
	"template ": "template ",
	...
	"The amount of the parent transaction in cents in split transactions.\n\nExample: `=(parent_amount / 100) * .05`": "The amount of the parent transaction in cents in split transactions.\n\nExample: `=(parent_amount / 100) * .05`",
	"The amount you plan to contribute to your Income Accounts each month. This amount is added to your balance each month before applying the investment return.": "The amount you plan to contribute to your Income Accounts each month. This amount is added to your balance each month before applying the investment return.",
	"The amount you plan to withdraw from your Income Accounts each year to fund your living expenses.<1></1><2>More info.</2>": "The amount you plan to withdraw from your Income Accounts each year to fund your living expenses.<1></1><2>More info.</2>",
	"The calculation uses the FIFO (First In, First Out) method: when you spend money, it's considered to come from your oldest income first. The age is the difference in days between when you received that income and when you spent it. The displayed value is the average age of your last 10 expenses.": "The calculation uses the FIFO (First In, First Out) method: when you spend money, it's considered to come from your oldest income first. The age is the difference in days between when you received that income and when you spent it. The displayed value is the average age of your last 10 expenses.",
	...
	"The expected annual return rate for your investments, used to project growth of Income Accounts.": "The expected annual return rate for your investments, used to project growth of Income Accounts.",
	...
	"The payee <2>{{previousPayee}}</2> is not used by transactions any more. Would you like to merge it with <6>{{payee}}</6>?": "The payee <2>{{previousPayee}}</2> is not used by transactions any more. Would you like to merge it with <6>{{payee}}</6>?",
	...
	"The transaction will appear as a schedule preview in your account.": "The transaction will appear as a schedule preview in your account.",
	...
	"There was a problem syncing your changes. Please confirm that your server is accessible.": "There was a problem syncing your changes. Please confirm that your server is accessible.",
	...
	"There was an error adding the dashboard widget. Please try again.": "There was an error adding the dashboard widget. Please try again.",
	"There was an error applying the budget action. Please try again.": "There was an error applying the budget action. Please try again.",
	...
	"There was an error closing the account. Please try again.": "There was an error closing the account. Please try again.",
	"There was an error copying the dashboard widget. Please try again.": "There was an error copying the dashboard widget. Please try again.",
	"There was an error creating the account. Please try again.": "There was an error creating the account. Please try again.",
	"There was an error creating the category group. Please try again.": "There was an error creating the category group. Please try again.",
	"There was an error creating the category. Please try again.": "There was an error creating the category. Please try again.",
	"There was an error creating the dashboard page. Please try again.": "There was an error creating the dashboard page. Please try again.",
	"There was an error creating the payee. Please try again.": "There was an error creating the payee. Please try again.",
	"There was an error creating the report. Please try again.": "There was an error creating the report. Please try again.",
	"There was an error creating the tag. Please try again.": "There was an error creating the tag. Please try again.",
	"There was an error deleting the category group. Please try again.": "There was an error deleting the category group. Please try again.",
	"There was an error deleting the category. Please try again.": "There was an error deleting the category. Please try again.",
	"There was an error deleting the dashboard page. Please try again.": "There was an error deleting the dashboard page. Please try again.",
	"There was an error deleting the report. Please try again.": "There was an error deleting the report. Please try again.",
	"There was an error deleting the tag. Please try again.": "There was an error deleting the tag. Please try again.",
	"There was an error deleting the tags. Please try again.": "There was an error deleting the tags. Please try again.",
	"There was an error discovering the tags. Please try again.": "There was an error discovering the tags. Please try again.",
	"There was an error forgetting the location. Please try again.": "There was an error forgetting the location. Please try again.",
	"There was an error importing preview transactions to the account. Please try again.": "There was an error importing preview transactions to the account. Please try again.",
	"There was an error importing the dashboard page. Please try again.": "There was an error importing the dashboard page. Please try again.",
	"There was an error importing transactions to the account. Please try again.": "There was an error importing transactions to the account. Please try again.",
	"There was an error linking the account to PluggyAI. Please try again.": "There was an error linking the account to PluggyAI. Please try again.",
	"There was an error linking the account to SimpleFIN. Please try again.": "There was an error linking the account to SimpleFIN. Please try again.",
	"There was an error linking the account. Please try again.": "There was an error linking the account. Please try again.",
	"There was an error moving the account. Please try again.": "There was an error moving the account. Please try again.",
	"There was an error moving the category group. Please try again.": "There was an error moving the category group. Please try again.",
	"There was an error moving the category. Please try again.": "There was an error moving the category. Please try again.",
	"There was an error re-opening the account. Please try again.": "There was an error re-opening the account. Please try again.",
	"There was an error removing the dashboard widget. Please try again.": "There was an error removing the dashboard widget. Please try again.",
	"There was an error renaming the dashboard page. Please try again.": "There was an error renaming the dashboard page. Please try again.",
	"There was an error resetting the dashboard page. Please try again.": "There was an error resetting the dashboard page. Please try again.",
	"There was an error saving the location. Please try again.": "There was an error saving the location. Please try again.",
	"There was an error syncing accounts. Please try again.": "There was an error syncing accounts. Please try again.",
	"There was an error unlinking the account. Please try again.": "There was an error unlinking the account. Please try again.",
	"There was an error updating the account. Please try again.": "There was an error updating the account. Please try again.",
	"There was an error updating the category group. Please try again.": "There was an error updating the category group. Please try again.",
	"There was an error updating the category. Please try again.": "There was an error updating the category. Please try again.",
	"There was an error updating the dashboard widget. Please try again.": "There was an error updating the dashboard widget. Please try again.",
	"There was an error updating the dashboard widgets. Please try again.": "There was an error updating the dashboard widgets. Please try again.",
	"There was an error updating the report. Please try again.": "There was an error updating the report. Please try again.",
	"There was an error updating the tag. Please try again.": "There was an error updating the tag. Please try again.",
	...
	"This account was not found in SimpleFIN. Try unlinking and relinking the account.": "This account was not found in SimpleFIN. Try unlinking and relinking the account.",
	...
	"This category uses notes-based automations (formerly \"budget templates\"). We have automatically imported your existing automations below. Please review them for accuracy and hit save to complete the migration.": "This category uses notes-based automations (formerly \"budget templates\"). We have automatically imported your existing automations below. Please review them for accuracy and hit save to complete the migration.",
	...
	"This is a <1>hosted file</1> shared with you. Only the file owner can delete it from the server.": "This is a <1>hosted file</1> shared with you. Only the file owner can delete it from the server.",
	...
	"This rule could not be deleted because it is linked to a schedule.": "This rule could not be deleted because it is linked to a schedule.",
	"This schedule has custom conditions and actions": "This schedule has custom conditions and actions",
	"This transaction has a future date. Would you like to convert it to a single-time schedule instead?": "This transaction has a future date. Would you like to convert it to a single-time schedule instead?",
	"This transaction will be deleted by Rules": "This transaction will be deleted by Rules",
	"This transfer has a linked transaction in another account that is reconciled. Deleting it may bring that account's reconciliation out of balance.": "This transfer has a linked transaction in another account that is reconciled. Deleting it may bring that account's reconciliation out of balance.",
	"This transfer has a linked transaction in another account that is reconciled. Duplicating it may bring that account's reconciliation out of balance.": "This transfer has a linked transaction in another account that is reconciled. Duplicating it may bring that account's reconciliation out of balance.",
	"This transfer has a linked transaction in another account that is reconciled. Editing it may bring that account's reconciliation out of balance.": "This transfer has a linked transaction in another account that is reconciled. Editing it may bring that account's reconciliation out of balance.",
	"This week": "This week",
	"This widget has failed to load.": "This widget has failed to load.",
	...
	Thursday,
	Time,
	"Time sync issue": "Time sync issue",
	"Timed out. Please try again.": "Timed out. Please try again.",
	to: "to",
	"to ": "to ",
	"To add a transaction, you need to <2>create a category first</2>. You can add categories from the budget page.": "To add a transaction, you need to <2>create a category first</2>. You can add categories from the budget page.",
	"To add a transaction, you need to <2>create an account first</2>. You can add an account from the accounts page.": "To add a transaction, you need to <2>create an account first</2>. You can add an account from the accounts page.",
	"To budget": "To budget",
	"To Budget": "To Budget",
	"To Budget:": "To Budget:",
	...
	"To:": "To:",
	Today,
	"Toggle balance history": "Toggle balance history",
	"Toggle cleared status for selected transactions": "Toggle cleared status for selected transactions",
	...
	transfer,
	Transfer,
	"Transfer {{direction}} {{accountName}}": "Transfer {{direction}} {{accountName}}",
	...
	"Transferred {{amount}} from {{fromCategoryName}} to {{toCategoryName}}.": "Transferred {{amount}} from {{fromCategoryName}} to {{toCategoryName}}.",
	"Transferred {{amount}} to {{categoryName}}": "Transferred {{amount}} to {{categoryName}}",
	"Transferring...": "Transferring…",
	Transfers,
	"Transfers:": "Transfers:",
	Trend,
	"Trim empty intervals at the start and end of the report": "Trim empty intervals at the start and end of the report",
	"Trim intervals": "Trim intervals",
	"Truncates number to specified decimals.": "Truncates number to specified decimals.",
	"Try again": "Try again",
	"Try Demo": "Try Demo",
	Tuesday,
	...
	"Un-migrate": "Un-migrate",
	"Un-migrate automations: {{category}}": "Un-migrate automations: {{category}}",
	...
	Unlinked,
	"Unlock budget file": "Unlock budget file",
	...
	Unnamed,
	"Unnamed schedule": "Unnamed schedule",
	...
	"Updated transaction. You can update it, import it again, or skip it.": "Updated transaction. You can update it, import it again, or skip it.",
	Upload,
	...
	"Use custom growth projections": "Use custom growth projections",
	...
	"Used to estimate your future expenses.<1></1><2></2>Select the budget categories that reflect your living expenses in retirement.<4></4>Ex: Food, Utilities, Entertainment, Medical<6></6><7></7>Exclude categories that will not continue in retirement.<9></9>Ex: Retirement Savings": "Used to estimate your future expenses.<1></1><2></2>Select the budget categories that reflect your living expenses in retirement.<4></4>Ex: Food, Utilities, Entertainment, Medical<6></6><7></7>Exclude categories that will not continue in retirement.<9></9>Ex: Retirement Savings",
	"Used to estimate your future income.<1></1><2></2>Select the accounts that will be used to fund your retirement.<4></4>Ex: Retirement Accounts, Savings Accounts<6></6><7></7>Exclude accounts that will not.<9></9>Ex: Mortgage Accounts, Child Education Accounts": "Used to estimate your future income.<1></1><2></2>Select the accounts that will be used to fund your retirement.<4></4>Ex: Retirement Accounts, Savings Accounts<6></6><7></7>Exclude accounts that will not.<9></9>Ex: Mortgage Accounts, Child Education Accounts",
	User,
	...
	"Using calculated historical return of {(historicalReturn * 100).toFixed(1)}%": "Using calculated historical return of {(historicalReturn * 100).toFixed(1)}%",
	...
	"Uzbek Soum": "Uzbek Soum",
	Value,
	"Value for out rows, e.g: 'Credit'": "Value for out rows, e.g: 'Credit'",
	"Variable with value: {{value}}": "Variable with value: {{value}}",
	...
	"We have merged your existing automations with the notes for this category. Please review and edit as needed.": "We have merged your existing automations with the notes for this category. Please review and edit as needed.",
	...
	"What is Age of Money?": "What is Age of Money?",
	"What is the Crossover Point?": "What is the Crossover Point?",
	When,
	...
	Yearly,
	Years,
	"Years to Retire": "Years to Retire",
	Yes: "Yes",
	"Yes, create schedule": "Yes, create schedule",
	You: "You",
	...
	"You have {{count}} overspent categories (<3>{{amount}}</3>)_one": "You have {{count}} overspent categories (<3>{{amount}}</3>)",
	"You have {{count}} overspent categories (<3>{{amount}}</3>)_other": "You have {{count}} overspent categories (<3>{{amount}}</3>)",
	"You have {{count}} uncategorized transactions (<3>{{amount}}</3>)_one": "You have {{count}} uncategorized transactions (<3>{{amount}}</3>)",
	"You have {{count}} uncategorized transactions (<3>{{amount}}</3>)_other": "You have {{count}} uncategorized transactions (<3>{{amount}}</3>)",
	...
	"Your budget data is encrypted with a key that only you have before sending it out to the cloud. Local data remains unencrypted so if you forget your password you can re-encrypt it. Note: bank sync operations and secrets stored on the server are not covered by end-to-end encryption.": "Your budget data is encrypted with a key that only you have before sending it out to the cloud. Local data remains unencrypted so if you forget your password you can re-encrypt it. Note: bank sync operations and secrets stored on the server are not covered by end-to-end encryption.",
